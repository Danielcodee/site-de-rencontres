          ...
          <Reveal>
            ...
            <ul className="mt-8 space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  <p className="font-heading text-sm font-semibold uppercase tracking-wide text-bone">Morada</p>
                  ...
                  <a
                    ...
                    className="mt-2 inline-block text-sm font-medium text-flame hover:underline"
                  >
                    Ver direções →
                  </a>
                </div>
              ...
              <li className="flex gap-4">
                ...
                <div>
                  <p className="font-heading text-sm font-semibold uppercase tracking-wide text-bone">Telefone</p>
              ...
              <li className="flex gap-4">
                <MessageCircle className="mt-1 shrink-0 text-flame" size={22} aria-hidden />
                <div>
                  <p className="font-heading text-sm font-semibold uppercase tracking-wide text-bone">WhatsApp</p>
                  <a
                    href={`https://wa.me/${siteConfig.contact.whatsappHref}`}
                    target="_blank"
                    rel="noreferrer noopener"
                    className="mt-1 block text-sm text-mist hover:text-flame"
                  >
              ...
              <li className="flex gap-4">
                <Mail className="mt-1 shrink-0 text-flame" size={22} aria-hidden />
                <div>
                  <p className="font-heading text-sm font-semibold uppercase tracking-wide text-bone">Email</p>
                  <a href={`mailto:${siteConfig.contact.email}`} className="mt-1 block text-sm text-mist hover:text-flame">
              ...
              <li className="flex gap-4">
                ...
                <div>
                  <p className="font-heading text-sm font-semibold uppercase tracking-wide text-bone">Horário</p>
            ...
            <div className="mt-8 flex gap-4">
              <a href={siteConfig.social.instagram} target="_blank" rel="noreferrer noopener" aria-label="Instagram" className="text-mist hover:text-flame">
                <InstagramIcon />
              </a>
              <a href={siteConfig.social.facebook} target="_blank" rel="noreferrer noopener" aria-label="Facebook" className="text-mist hover:text-flame">
                <FacebookIcon />
              </a>
              <a href={siteConfig.social.youtube} target="_blank" rel="noreferrer noopener" aria-label="YouTube" className="text-mist hover:text-flame">
                <YoutubeIcon />
              </a>
              <a href={siteConfig.social.tiktok} target="_blank" rel="noreferrer noopener" aria-label="TikTok" className="text-mist hover:text-flame">
                <TiktokIcon />
              </a>
            </div>
          ...
          <dl className="mx-auto mt-14 max-w-3xl divide-y divide-line border-y border-line">
            {faqs.map((faq) => (
              <div key={faq.question} className="py-6">
                <dt className="font-heading text-base font-semibold uppercase tracking-wide text-bone">
                  {faq.question}
                </dt>
