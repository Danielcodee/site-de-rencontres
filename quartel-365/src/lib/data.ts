...
// — cada zona/modalidade tem a sua própria foto, em vez de repetir sempre a
// mesma imagem. Substituir por fotografia própria assim que o espaço abrir.
...
export const siteConfig = {
  ...
  // Sem Facebook, LinkedIn nem YouTube — o Quartel 365 não tem (nem vai
  // ter) presença nessas redes.
  social: {
